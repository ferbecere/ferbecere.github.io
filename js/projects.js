...
const PROJECTS = [
  {
    ...
    info: `
    ##Contexto
    Desarrollo de un producto bajo una necesidad personal real: La gestión de la alimentación infantil.
    ...
    ##Stack
           - React18 + vite: La idea siempre fue crear una SPA. 
    ...
    ##Retos
          - Adaptar la información de la guia ya que muchas normas no eran vinárias por lo que se tenian que definir márgenes de edad.
  ...
  },
  {
    ...
    info: `
    ##Contexto
     Artline es un juego multijugador en tiempo real basado en el juego de cartas Timeline. Dos jugadores deben ordenar cronológicamente obras del MET. El que las ordene mas facilmente gana.
    ##Stack
           - Next.js16 (con AppRouter) y TypeScript: Base del proyecto
    ...
    ##Retos
           - Conectar la arquitectura del servidor: Next.js gestiona el frontend mientras que el servidor Node.js maneja los WebSockets. Sincronizar el el ciclo de vida de ambos y que Railway los sirviera correctamente requirió de varias iteraciones.
  ...
  },
  {
    ...
    ##Stack
           ...
           - Deploy en Vercel
    ##Retos
           - Parseo de la API de wikipedia: Esta no tiene un endpoint directo de "eventos del año X". Se encadenan tres llamadas: obtener los ídnices de scción del artículo del año busacdo. Selecionar las seccioens (Events, Births, Deaths) y resolver los links internso de wikitext para tener un extracto de cda artículo.
  ...
  },
  {
    ...
    ##Retos 
           - La gestión del estado sin un frameworks requeria actualiar el estado y sincronizar manualmente el DOm. Entonces es importante ser muy explícito sobre qué función tiene cada responsabildiad.
...
const SKILLS = [
  ...
  'Figma', 'Js & Ts', 'Supabase', 'Angular',
  'CSS & tailwind', 'Node.js', 'React', 'Next.js',
  'REST API',
];
